...
<petclinic:layout pageName="prescriptions">
    ...
    <table id="prescriptionsTable" class="table table-striped">
        ...
        <tr>
            ...
            <th style="width: 150px;">Dias de duraci�n</th>
        ...
        <c:forEach items="${prescriptions}" var="prescription">
            <tr>
                <td>
                    <spring:url value="/patient/prescriptions/{prescriptionId}" var="prescriptionUrl">
                        <spring:param name="prescriptionId" value="${prescription.id}"/>
                    </spring:url>
                    <a href="${fn:escapeXml(prescriptionUrl)}"><c:out value="${prescription.medicine.genericalName} - ${prescription.medicine.commercialName}"/></a>
                </td>
                <td>
