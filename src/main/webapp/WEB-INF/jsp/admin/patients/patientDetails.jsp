...
<petclinic:layout pageName="patients">
	...
	<c:if test="${isErasable}">
		<td><spring:url value="/admin/patients/{patientId}/delete" var="patientUrl">
				<spring:param name="patientId" value="${patient.id}" />
			</spring:url> <a href="${fn:escapeXml(patientUrl)}">Eliminar paciente</a></td>
	</c:if>
