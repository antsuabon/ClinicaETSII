...
public class AdministrativeAppointmentController {
	...
	@Autowired
	public AdministrativeAppointmentController(final AppointmentService appointmentService,
	...
	public String generateTableAdmin(@PathVariable("patientId") final int patientId,
			final Map<String, Object> model) {
		Patient patient = this.patientService.findPatientById(patientId);
		List<LocalDateTime> citas = new ArrayList<>(this.appointmentService
				.findAppointmentByDoctors(patient.getGeneralPractitioner().getId()));
	...
	public String initCreationForm(@PathVariable("patientId") final int patientId,
			@RequestParam("fecha") final LocalDateTime fecha,
			final Map<String, Object> model) {
	...
	public String processCreationForm(@PathVariable("patientId") final int patientId,
			@Valid final Appointment appointment,
