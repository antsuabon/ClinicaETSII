...
class ExaminationServiceTests {
	...
	@Test
	void shouldFindExaminationById() {

		Examination examination = this.examinationService.findExaminationsById(1);

		Assertions.assertThat(examination).isNotNull();

		Assertions.assertThat(examination.getId()).isNotNull().isEqualTo(1);

	}


	@Test
	void shouldNotFindExaminationById() {

		Examination examination = this.examinationService.findExaminationsById(-1);

		Assertions.assertThat(examination).isNull();
