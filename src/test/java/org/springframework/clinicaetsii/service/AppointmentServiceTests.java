...
class AppointmentServiceTests {
	...
	void shouldFindAppointmentsByDoctorId() {
		Collection<LocalDateTime> fechasInicioAppointments1 = this.appointmentService.findAppointmentByDoctors(1);
		Assertions.assertThat(fechasInicioAppointments1.size()).isEqualTo(3);

		Collection<LocalDateTime> fechasInicioAppointments2 = this.appointmentService.findAppointmentByDoctors(-1);
