...
public class AdministrativeMedicineControllerE2ETests {
	...
	void deleteMedicine() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.get(
					"/administrative/medicines/{medicineId}/delete", 1))
				.andExpect(MockMvcResultMatchers.status().is3xxRedirection())
				.andExpect(MockMvcResultMatchers.view()
						.name("redirect:/administrative/medicines"));
	}
	...
	void shouldInitEditMedicineForm() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.get("/administrative/medicines/{medicineId}/edit",1))
				.andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.model().attributeExists("medicine"))
	...
	void shouldProcessEditMedicineForm() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.post("/administrative/medicines/{medicineId}/edit",1).with(SecurityMockMvcRequestPostProcessors.csrf())
