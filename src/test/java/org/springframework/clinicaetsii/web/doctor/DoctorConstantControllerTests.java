...
@WebMvcTest(controllers = DoctorConstantController.class,
		includeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE,
				classes = ConstantTypeFormatter.class),
...
public class DoctorConstantControllerTests {
	...
	private void initConstants() {
		...
		BDDMockito.given(this.constantService.findAllConstantTypes())
				.willReturn(this.constantTypes);
		BDDMockito.given(this.consultationService.findConsultationById(1))
	...
	void testInitConstantCreation() throws Exception {
		this.mockMvc
				...
				.andExpect(MockMvcResultMatchers.model().attribute("constantTypes",
						this.constantTypes))
	...
	void testInitConstantEdition() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get(
				...
				1, 1, 1)).andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.model().attribute("constantTypes",
						this.constantTypes))
				.andExpect(MockMvcResultMatchers.view()
						.name("/doctor/consultations/createOrUpdateConstantForm"));
	...
	void testProcessConstantEdition() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.post(
				"/doctor/patients/{patientId}/consultations/{consultationId}/constants/{constantId}/edit",
				1, 1, 1).with(SecurityMockMvcRequestPostProcessors.csrf())
	...
	void testNotProcessConstantEdition() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.post(
				"/doctor/patients/{patientId}/consultations/{consultationId}/constants/{constantId}/edit",
				1, 1, 1).with(SecurityMockMvcRequestPostProcessors.csrf())
				.param("constantType", "6").param("value", "-5"))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.model().attributeHasErrors("constant"))
				.andExpect(MockMvcResultMatchers.model().attributeHasFieldErrors("constant",
						"constantType", "value"))
